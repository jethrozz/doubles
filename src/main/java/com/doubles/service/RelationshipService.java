...
public interface RelationshipService {
    ...
    Page<Relationship> findPageFollowFriends(int pageNo,int pageSize,String user_id);
    Page<Relationship> findPageFansFriends(int pageNo,int pageSize,String user_id);
