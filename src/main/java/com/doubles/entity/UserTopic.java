...
public class UserTopic implements Serializable {
    ...
    **/
    ...
    public UserTopic withUp_id(String up_id) {
        this.setUp_id(up_id);
        return this;
    }

    public void setUp_id(String up_id) {
        this.up_id = up_id == null ? null : up_id.trim();
    }
    ...
    public UserTopic withUser_id(String user_id) {
    ...
    public UserTopic withTopic_id(String topic_id) {
